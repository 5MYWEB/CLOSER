...
import com.ssafy.closer.model.service.CommentService;
...
//    @PostMapping("/{id}/like")
//    public ResponseEntity likeLboard(@PathVariable int id, HttpServletRequest request){
...
//    public ResponseEntity bookmarkLboard(@PathVariable int id, HttpServletRequest request){
...
//
//    // 7. Lboard 댓글 수 띄우기
//    @ApiOperation(value="Lboard 댓글 수")
//    @PostMapping("/{id}/comment_cnt")
//    public ResponseEntity commentCntLboard(@PathVariable int id, HttpServletRequest request){
//        logger.debug(id +"/comment_cnt" + ": Lboard 댓글 수");
//
//        try {
//            // 유저 정보가 담긴 likeDto 생성
//            CommentDto commentDto = new CommentDto();
//            commentDto.setKind_pk(2);
