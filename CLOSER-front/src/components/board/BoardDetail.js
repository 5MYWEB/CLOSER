...
const BoardDetail = ({match}) => {
  ...
  // 그룹채팅방으로 이동
  const GroupChat = () =>{
    history.push(`/messages/${board.board_pk}`)
  }
  ...
  return (
      <Container className="page-wrapper">
        <div className="mx-5">
          ...
          <div
              className="d-flex justify-content-between align-items-center border-bottom border-2 border-secondary pb-1 mb-3"
              style={{borderBottomColor: "#5552FF"}}>
