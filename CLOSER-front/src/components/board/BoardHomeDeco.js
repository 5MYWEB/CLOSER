...
function BoardHomeDeco() {
  ...
  useEffect(() => {
    axios.post('http://localhost:8080/board/gBoard/deco/weekbest')
    .then((res) => {
    ...
    axios.post('http://localhost:8080/board/gBoard/deco/new')
    .then((res) => {
    ...
    axios.post('http://localhost:8080/board/gBoard/deco/best')
    .then((res) => {
