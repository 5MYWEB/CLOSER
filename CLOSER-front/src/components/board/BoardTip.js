...
function BoardTip() {
  ...
  useEffect(() => {
    axios.post('http://localhost:8080/board/gBoard/tip/weekbest')
    .then((res) => {
    ...
    axios.post('http://localhost:8080/board/gBoard/tip/new')
    .then((res) => {
    ...
    axios.post('http://localhost:8080/board/gBoard/tip/best')
    .then((res) => {
