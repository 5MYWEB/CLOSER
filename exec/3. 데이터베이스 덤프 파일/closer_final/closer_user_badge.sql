...
CREATE TABLE `user_badge` (
  ...
  KEY `userId` (`userId`),
  CONSTRAINT `user_badge_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `user_badge` VALUES (1,'minji',NULL,1,NULL),(2,'yongmi',NULL,1,NULL),(3,'minsu',NULL,1,NULL),(4,'youngcheol',NULL,2,NULL),(5,'minsu',NULL,2,NULL),(6,'jiyoon',NULL,3,NULL),(7,'sungjae',NULL,3,NULL);
