...
CREATE TABLE `user_bot` (
  `bot_pk` int NOT NULL AUTO_INCREMENT,
  `userId` varchar(20) NOT NULL,
  `content` varchar(100) NOT NULL,
  `alarm_day` varchar(10) DEFAULT NULL,
  `alarm_date` date DEFAULT NULL,
  PRIMARY KEY (`bot_pk`),
  KEY `userId` (`userId`),
  CONSTRAINT `user_bot_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `user_bot` VALUES (1,'ssafy','SSAFY 발표!',NULL,'2021-08-20'),(2,'ssafy','분리수거 하는 날','6',NULL);
